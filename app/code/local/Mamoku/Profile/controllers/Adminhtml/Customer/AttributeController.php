 ...
 * @author root
 */
class Mamoku_Profile_Adminhtml_Customer_AttributeController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function saveAction()
    {
        ...
        if ($data) {
            ...
            /* @var $model Mamoku_Profile_Model_Customer_Attribute */
            $model = Mage::getModel('profile/customer_attribute');
            /* @var $helper Mamoku_Profile_Helper_Product */

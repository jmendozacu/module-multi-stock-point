...
class Mamoku_Multistockpoint_Block_Adminhtml_Kelurahan_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
		...
		{
				if( Mage::registry("kelurahan_data") && Mage::registry("kelurahan_data")->getId() ){

				    return Mage::helper("multistockpoint")->__("Edit Item '%s'", $this->htmlEscape(Mage::registry("kelurahan_data")->getId()));

...
class Mamoku_Multistockpoint_Block_Adminhtml_Kecamatan_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
		...
		{
				if( Mage::registry("kecamatan_data") && Mage::registry("kecamatan_data")->getId() ){

				    return Mage::helper("multistockpoint")->__("Edit Item '%s'", $this->htmlEscape(Mage::registry("kecamatan_data")->getId()));
